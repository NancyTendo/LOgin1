  ...
  <body>
	<div class="container">
		...
		<div class="login-form">
			...
			<div class="form-header"  style="background-image: url('login/logooo.png');>
			...
			<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-register" role="form" id="register-form">
				...
				<button class="btn btn-block bt-login" type="submit" id="submit_btn" data-loading-text="Iniciando....">Registrase con facebook</button>
				<button class="btn btn-block bt-login" type="submit" id="submit_btn" data-loading-text="Iniciando....">Registrarse con Gmail</button>
			</form>
